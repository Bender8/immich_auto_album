IMMICH_BASE_URL: str = "http://localhost:2283"  # URL to your Immich instance. ex. "http://192.168.1.28:2283"
API_KEY: str = "YOUR_API_KEY_HERE"  # Your API key from Immich
MAX_CONCURRENT_REQUESTS: int = 4

# A list of dictionaries defining"Sync Rules"
# Format: {"name": "Album Name", "key": "Search Field Name", "val": "matching data in feild"}
...
# Photos will be added if any of the people listed are in the photo
# You can list as many people as you want
# an example call "Things" is also shown below. This will create an album of photos without faces
# an album of all photos without faces can be useful for finding photos with missing faces
